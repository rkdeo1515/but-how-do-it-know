...
void UINT8ToASCIIHex(uint8_t hex, unsigned char *ascii);
void UINT16ToASCIIHex(uint16_t hex, unsigned char *ascii);
void UINT32ToASCIIHex(uint32_t hex, unsigned char *ascii);
void UINT64ToASCIIHex(uint64_t hex, unsigned char *ascii);
void UINTxToASCIIHex(size_t hex, unsigned char *ascii);
size_t ASCIIHexToUINTx(unsigned char *ascii, int len);
